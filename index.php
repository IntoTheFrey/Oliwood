...
<body id="home" class="flex flexColumn">
  ...
  <main id="content" class="wrapper" role="main">
    ...
    <section class="promo">
      ...
      <img src="img/TurtleFromEast.jpg" width="100%">
    ...
    <section class="about">
      <div class="subNav" id="about">About</div>

      <h1>Comfortable mountainside cottage with</h1>
      <h1>incredible views of the Crowsnest Pass!</h1>
      ...
      <div class="hotTub">
        <img class="imgAbout" src="img/Hottub1.jpg" width="100%"/>
    ...
    <section class="amenities">
      <div class="subNav" id="amenities">Facilities & Amenities</div>

      <article class="flex flexRow">
        <div class="innerText flex flexColumn flexSpaceAround">
          <h2>Kitchen</h2>
        ...
        <figure>
          <img src="img/MKitch1.jpg" width="100%" height="100%">
        </figure>
      </article>

      <article class="flex flexRow">
        <figure>
          <img src="img/MBed1.jpg" width="100%" height="100%">
        </figure>
      ...
      <article class="flex flexRow">
        <div class="innerText flex flexColumn flexSpaceAround">
          <h2>Shared</h2><h2>Common Spaces</h2>
        ...
        <figure>
          <img src="img/MDeck1.png" width="100%" height="100%">
        </figure>
      </article>
    ...
    <section>
      <div class="subNav" id="location">Location</div>
      ...
      <img class="imgAbout" src="img/winter.jpg" width="100%"/>
    </section>
    
    <section class="calendar">
      <div class="subNav" id="calendar">Availability</div>
      <?php include_once("calendar.php"); ?>
    </section>
    
    <section class="rates">
      <div class="subNav" id="rates">Rates</div>      
    ...
    <section id="sectionContact">
      <div class="subNav" id="contact">Contact Us</div>
